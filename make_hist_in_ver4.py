...
def readdefelem(atom,df_csv): #------------------------------------------------------------------------------
    ...
    df_elem=df_csv.loc[0:101,'atomic_num.':'spdf-block']
    elem_list=df_elem.to_numpy().tolist()
...
def compdescript(aparam2,aparam3,reference):
    ...
    for FN in filename:     
        if FN == "PG":
            ...
            while  i<=len(x[0]) - 1:
                ...
                while  j<=len(x[0]) - 1:    
                    ...
                    if int(y(ENatom1,df_csv)[FN][ENatom1]) > int(y(ENatom2,df_csv)[FN][ENatom2]):     
                        kk1=y(ENatom2,df_csv)[FN][ENatom2]  
                        kk2=y(ENatom1,df_csv)[FN][ENatom1]
                    else:     
                        kk2=y(ENatom2,df_csv)[FN][ENatom2]  
                        kk1=y(ENatom1,df_csv)[FN][ENatom1]
        ...
        if FN == "PN":
            ...
            while i<=len(x[0]) -1:     
                ...
                while  j<=len(x[0])-1:      
                    ...
                    ENatom2=x[2][j]      
                    inty2=x[0][j]/x[3]      
                    if y(ENatom1,df_csv)[FN][ENatom1] > y(ENatom2,df_csv)[FN][ENatom2]:     
                        kk1=y(ENatom2,df_csv)[FN][ENatom2]  
                        kk2=y(ENatom1,df_csv)[FN][ENatom1]      
                    else:     
                        kk2=y(ENatom2,df_csv)[FN][ENatom2]  
        ...
        while  i <= len(x[0])-1:
            ENatom=x[2][i]
            inty=x[0][i]/x[3]
            if y(ENatom,df_csv)[FN][ENatom] != 'nodata':      
                f_list_index.append("{} {:1.6f} {:1.6f}".format(ENatom,float(y(ENatom,df_csv)[FN][ENatom]),inty))
                f_list_columns.append('out.{}_{}'.format(FN,i))
            else:
                i=i+1
                return 'owari'
                #f_list_index.append("{} {} {:1.6f}".format(ENatom,y(ENatom,df_csv)[FN][ENatom],inty))
                #f_list_columns.append('out.{}_{}'.format(FN,i))
            i = i + 1
        ...
        if aparam3 == 'T':
            ...
            while i<=len(x[0])-1:     
                ...
                while j <= len(x[0]) - 1 :     
                    ...
                    ENatom2=x[2][j]      
                    inty2=x[0][j]/x[3]
                    if y(ENatom1,df_csv)[FN][ENatom1] != 'nodata' and y(ENatom2,df_csv)[FN][ENatom2] != 'nodata':
                        m_list_index.append("{}-{} {:1.6f} {:1.6f}".format(ENatom1,ENatom2,math.log(float(y(ENatom1,df_csv)[FN][ENatom1]))+math.log(float(y(ENatom2,df_csv)[FN][ENatom2])),inty1+inty2))
                        m_list_columns.append('out.{}{}_{}'.format(FN,FN,i))
                        #m_list_index.append("{}-{} {} {:1.6f}".format(ENatom1,ENatom2,y(ENatom1,df_csv)[FN][ENatom1],inty1+inty2))
                        #m_list_columns.append('out.{}{}_{}'.format(FN,FN,i))
                        #m_list_index.append("{}-{} {} {:1.6f}".format(ENatom1,ENatom2,y(ENatom2,df_csv)[FN][ENatom2],inty1+inty2))
                        #m_list_columns.append('out.{}{}_{}'.format(FN,FN,i))
                    else:
                        return 'owari'
                        #m_list_index.append("{}-{} {} {:1.6f}".format(ENatom1,ENatom2,y(ENatom2,df_csv)[FN][ENatom2],inty1+inty2))
            ...
            while i<=len(x[0])-1:      
                ...
                while j <= len(x[0])-1:     
                    ...
                    inty2=x[0][j]/x[3]  
                    if y(ENatom1,df_csv)[FN][ENatom1] != 'nodata' and y(ENatom2,df_csv)[FN][ENatom2] != 'nodata':
                        o_list_index.append("{}-{} {} {:1.6f}".format(ENatom1,ENatom2,abs(float(y(ENatom1,df_csv)[FN][ENatom1])-float(y(ENatom2,df_csv)[FN][ENatom2])),inty1+inty2))      
                        o_list_columns.append('out.{}-{}_{}'.format(FN,FN,i))
                    elif y(ENatom1,df_csv)[FN][ENatom1] == 'nodata' and y(ENatom2,df_csv)[FN][ENatom2] != 'nodata':
                        j=j+1
                        return 'owari'
                        #o_list_index.append("{}-{} {} {:1.6f}".format(ENatom1,ENatom2,y(ENatom1,df_csv)[FN][ENatom1],inty1+inty2))      
                        #o_list_columns.append('out.{}-{}_{}'.format(FN,FN,i))
                    elif y(ENatom1,df_csv)[FN][ENatom1] != 'nodata' and y(ENatom2,df_csv)[FN][ENatom2] == 'nodata':
                        j=j+1
                        return 'owari'
                        #o_list_index.append("{}-{} {} {:1.6f}".format(ENatom1,ENatom2,y(ENatom2,df_csv)[FN][ENatom2],inty1+inty2))      
                        #o_list_columns.append('out.{}-{}_{}'.format(FN,FN,i))
                    else:
                        j=j+1
                        return 'owari'
